...
import { ArrowLeft, Users, Calendar, BarChart2, Flag, Mail, Trophy, Sparkles, MessageCircleQuestion, Palette, Banknote, Plane, ReceiptText, ScanLine } from "lucide-react";
...
export default function AdminTripDetail() {
  ...
  const navItems: NavItem[] = [
    ...
    { href: `/admin/trips/${tripId}/appearance`, icon: Palette, label: "Trip Appearance & Event Days" },
    { href: `/admin/trips/${tripId}/finances`, icon: Banknote, label: "Trip Finances & Payments" },
    { href: `/admin/trips/${tripId}/financial-reports`, icon: ReceiptText, label: "Financial Reports & Supplier Reminders" },
    { href: `/admin/trips/${tripId}/receipt-ocr`, icon: ScanLine, label: "Receipt OCR Expense Entry" },
    { href: `/trip/${tripId}/itinerary`, icon: Plane, label: "Travel & Accommodation Itinerary" },
