...
import { Flag, BarChart2, Bell, Users, ChevronRight, ArrowLeft, Trophy, Calendar, MessageCircle, Download, Swords, Target, Settings, MapPin, FileText, User, Zap, BookOpen, Sparkles, Wallet, Plane } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-5xl mx-auto px-6 py-8 space-y-8">
        ...
        <Link href={`/trip/${id}/itinerary`}><div className="cursor-pointer rounded-xl border border-border bg-card px-5 py-4 transition-colors hover:border-primary/40 hover:bg-primary/5"><div className="flex items-center gap-3"><Plane className="h-5 w-5 text-primary" /><div className="min-w-0 flex-1"><p className="font-semibold text-foreground">Travel itinerary</p><p className="mt-1 text-sm text-muted-foreground">Transport, accommodation and shared trip plans</p></div><ChevronRight className="h-4 w-4 text-muted-foreground" /></div></div></Link>
        <Link href={`/trip/${id}/documents`}><div className="cursor-pointer rounded-xl border border-border bg-card px-5 py-4 transition-colors hover:border-primary/40 hover:bg-primary/5"><div className="flex items-center gap-3"><FileText className="h-5 w-5 text-primary" /><div className="min-w-0 flex-1"><p className="font-semibold text-foreground">Trip documents</p><p className="mt-1 text-sm text-muted-foreground">Shared travel, booking, and trip files</p></div><ChevronRight className="h-4 w-4 text-muted-foreground" /></div></div></Link>
        {/* Trip Description */}
