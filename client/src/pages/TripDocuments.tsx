...
export default function TripDocuments() {
  ...
  const visibleDocuments = useMemo(() => {
    ...
    return documents.filter((document) => (filter === "All folders" || (document.folder || "General") === filter) && (!term || [document.title, document.folder, document.tags, document.fileName].filter(Boolean).some((value) => String(value).toLowerCase().includes(term))));
